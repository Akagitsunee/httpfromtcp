...
func TestReadHeader(t *testing.T) {
	...
	require.NotNil(t, r)
	assert.Equal(t, "localhost:42069", r.Headers["host"])
	assert.Equal(t, "USD, BTC", r.Headers["set-currency"])
...
func TestReadBodyErrors(t *testing.T) {
	...
	require.Error(t, err)
	assert.Nil(t, r)
	assert.Contains(t, err.Error(), "malformed Content-Length")
	...
	require.Error(t, err)
	assert.Nil(t, r)
	assert.Contains(t, err.Error(), "Content-Length too large")
}

func TestRequestFromReaderErrors(t *testing.T) {
